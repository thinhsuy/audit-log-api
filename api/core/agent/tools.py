...
def params_format(
    ...
    return {
        "name": name,
        "values": {"type": type, "description": description},
        "required": required,
    }
    ...
    return {
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    param["name"]: param["values"] for param in params
                },
                "required": [
                    param["name"]
                    for param in params
...
async def search_data_postgres(
    user_query: str, additional_params: ToolAdditionalParams = None
):
    """
...
def generate_search_data_postgres_spec(params: list = []):
    params.append(
        params_format(
            ...
            type="string",
            description=dedent(
                "Query of user, which is converted into English. \
...
AUDIT_LOG_FUNCTION_SPEC = [generate_search_data_postgres_spec()]
